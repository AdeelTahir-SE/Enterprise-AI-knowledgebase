    ...
    <footer className="bg-white border-t border-border">
      <div className="container-main pt-16 pb-10">
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-7 gap-10 mb-14">
          {/* Brand Column */}
          <div className="col-span-2 md:col-span-3 lg:col-span-2 pr-6">
            {/* Logo */}
            ...
            <p className="text-sm text-text-light leading-relaxed mb-5 max-w-xs">
              Enterprise AI Knowledge Platform to build, manage and deploy intelligent assistants over your private data.
            </p>
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.label}
                  href={social.href}
                  className="w-8 h-8 rounded-lg bg-section-bg flex items-center justify-center text-text-light hover:bg-primary hover:text-white transition-all"
          ...
          {Object.entries(footerLinks).map(([category, links]) => (
            <div key={category}>
              <h4 className="text-sm font-bold text-text-dark mb-4">{category}</h4>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between pt-6 border-t border-border gap-4">
          <p className="text-xs text-text-lighter">
            © 2024 KnowMatrix.AI. All rights reserved.
          </p>
